<?php 
define('API', 'https://ideaapps.space/otp/api.php');
class Otp {
...
//logfile($jsonObjectFields);
	...
	public function RegOtp( $method, $mobile, $app_key)
	...
	public function VerfyOtpZZ($applicationId, $password, $referenceNo, $otp)
